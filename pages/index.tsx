...
const DescBlock = (args:{title: string, desc: string}[]) =>
  args.map(({title, desc}) =>
    <div key={title} className='p-6 mt-4 sm:mx-10 text-left border rounded-lg border-transparent bg-slate-800' >
...
const Home: NextPage = () => {
  return (
    <div className='flex flex-col items-center justify-center m-auto min-h-screen min-w-0 overflow-auto overflow-x-auto text-emerald-500 bg-slate-900'>
      <Head>
        <title>Cameron Henry</title>
      </Head>
      <main className='flex flex-col items-center justify-center md:w-[40rem] min-w-0 text-center'>
        <div className='md:border-x border-t w-full sm:mx-20 pb-1 min-w-0 border-slate-500'>
          <h1 className='sm:ml-3 text-left text-5xl font-bold'>
            Cameron Henry{' '}
          </h1>
          <p className='sm:ml-4 mt-1 text-left text-2xl text-sky-300'>
            Software Engineer{' '}
          </p>
          <p className='sm:ml-4 mb-3 text-xs text-left text-sky-400'>
            cameronhenryexe@gmail.com
          </p>
          <p className='sm:mx-4 mt-1 mb-3 text-sm text-left'>
        ...
        <div className='md:border-x sm:mx-20 pb-2 w-full min-w-0 border-slate-500'>
          <div className='border-t border-slate-500'>
            <h1 className='flex justify-left sm:ml-10 mt-2 text-3xl font-bold text-sky-300'>
              About Me
            </h1>
          ...
          <div>
            <h1 className='flex justify-left sm:ml-10 mt-6 text-3xl font-bold text-sky-300'>
              Technical Skills
            </h1>
            <div className='flex flex-row justify-between sm:mx-10'>
              {SkillBlock({
                title: 'Languages',
          ...
          <div className='mt-6 pr-1'>
            ...
            <ul className='text-left list-disc sm:mx-10 mt-2 sm:pl-6 text-xl font-bold marker:text-sky-400'>
              <li className='mt-2'>
                Reynolds and Reynolds, Houston — Software Engineer
                <ul className='list-disc sm:pl-5 text-sm font-normal'>
                  <li>
